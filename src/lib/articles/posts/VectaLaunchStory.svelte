<article class="article-body">
  ...
  <h2>情報を、もっとつなげたい。AIを、もっと身近に</h2>

  <p>Qdrantに触れたとき、私たちはこう考えました。</p>
  ...
  <h2>公式ホームページを開設しました</h2>

  <p>このたび、株式会社Vectaの公式ホームページを開設しました。</p>
